...
const BUILTIN_FIELD_ALIASES: Record<ImportFieldKey, string[]> = {
  date: ['date', 'day', '일자', '날짜'],
  work_date: ['work_date', '작업일', '단조작업일', '작업일자', '일자', '날짜'],
  ym: ['ym', 'month', '월', '기준월'],
  work_month: ['work_month', '작업월', '월', '기준월'],
  year: ['year', '연도', '년도', '기준연도'],
  dept: ['dept', '부서', '작업부서', '라인', '조직'],
  dept_line: ['dept_line', '작업부서', '작업장', '프레스별', '부서', '라인'],
  line_code: ['line_code', '라인코드', '생산라인', '공정라인', '프레스별'],
  product: ['product', '제품'],
  product_name: ['product_name', '제품명', '소재품명', '품명', '제품'],
  material: ['material', '재질', '소재'],
  raw_material: ['raw_material', '원소재', '원자재', '소재'],
  spec: ['spec', '규격', '스펙', '사양'],
  process: ['process', '공정'],
  shift: ['shift', '주야', '주간', '야간', '주간조', '야간조', 'day', 'night', 'both'],
  scope: ['scope', '범위', '적용범위', '구분'],
  ref: ['ref', '기준', '대상', '참조'],
  metric: ['metric', '지표', '항목', '측정값'],
  basis: ['basis', '기준', '근거', '장입기준', '수주기준'],
  value: ['value', '값', '검침값', '가스사용량', '가스값검침', '검침량'],
  target_value: ['target_value', '목표값', '목표', '기준값'],
  charge_weight_kg: ['charge_weight_kg', '장입량', '투입중량', 'kg'],
  charge_weight: ['charge_weight', '장입량', '투입중량'],
  gas_usage: ['gas_usage', '가스사용량', '가스값검침', '사용량', '검침값'],
  source: ['source', '출처', '구분'],
  min_ton: ['min_ton', '최소투입중량', '최소중량', '하한', 'min'],
  max_ton: ['max_ton', '최대투입중량', '최대중량', '상한', 'max'],
  std_work_count: ['std_work_count', '표준작업수', '표준횟수', '기준작업수'],
  ...
  actual_ton: ['actual_ton', '생산량', '생산중량', '생산중량(양품)'],
  ...
  work_count: ['work_count', '작업횟수', '실적', '양품', '횟수', 'count'],
